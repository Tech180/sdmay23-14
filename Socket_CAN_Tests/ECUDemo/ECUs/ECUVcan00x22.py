...
#Sniffs PGN values equal to 22 or broadcast PGN values equal to 240 or greater
def sniffPGN_Broadcast(msg):
    ...
    if((pgn_1 == "22" and int(pgn_1,16) < 240) or int(pgn_1,16) >= 240):  #Sniffing the values to print
        print(msg)
...
def sniffPGN_Direct(msg):
    ...
    if(pgn_1 == "22" and int(pgn_1,16) < 240):  #Sniffing the values to print
        print(msg)
