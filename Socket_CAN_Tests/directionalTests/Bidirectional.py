...
def on_get_message(msg):
  ...
  data_msg.append(int(pgn_1, 16)) #pgn added to can frame
  data_msg.append(int(pgn_2, 16)) #pgn added to can frame
  data_msg.append(int(source_address, 16)) #source address added to can frame
...
def finalize_send_message_vcan1():
  ...
  global data_msg, t1, currentMonotonicCounter1
  ...
  data_msg.append(int(str(currentMonotonicCounter1[0]), 16)) # 5 bytes of freshness value being added to canfd frame
  data_msg.append(int(str(currentMonotonicCounter1[1]), 16)) # 5 bytes of freshness value being added to canfd frame
  data_msg.append(int(str(currentMonotonicCounter1[2]), 16)) # 5 bytes of freshness value being added to canfd frame
  data_msg.append(int(str(currentMonotonicCounter1[3]), 16)) # 5 bytes of freshness value being added to canfd frame
  data_msg.append(int(str(currentMonotonicCounter1[4]), 16)) # 5 bytes of freshness value being added to canfd frame
